...
int main()
{
	...
	Mat Result2;
	equalizeHist(im, Result2);

	namedWindow("histogram equalization");
	imshow("histogram equalization", Result2);

	Mat Resulthist2;
	calcHist(&Result2, narrays, channels, Mat(), Resulthist2, dims, histSize, ranges);

	name = "histogram equalization hist";
	histShow(Resulthist, name);
